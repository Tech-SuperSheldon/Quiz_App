...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 p-4 pb-3 border-b border-white/10 flex-shrink-0 transition-all duration-500 ${
          collapsed ? "p-2" : "p-4"
      ...
      >
        ...
        <button
          ...
          className="p-2 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-all duration-300 hover:scale-110 flex items-center justify-center"
